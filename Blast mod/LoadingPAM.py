"""
A PAM250 (250% mmutations per position)is a commonly used scoring matrix for sequence comparison.
Not Restricted to Block Segments
More Adequate for assesing the likelihood of characters substitution in closely related proteins
"""
DictPAM = {}
